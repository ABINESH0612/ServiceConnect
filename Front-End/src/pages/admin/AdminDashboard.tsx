...
import {
  Users, Headphones, BookOpen, ClipboardList, ShieldCheck,
  CheckCircle2, Clock, AlertTriangle, ArrowRight, UserCheck, Activity
} from 'lucide-react'
...
export default function AdminDashboard() {
  // Query pending and approved providers
  ...
  // Query registered customers / users
  ...
  const totalUsers = usersData?.length ?? 12
