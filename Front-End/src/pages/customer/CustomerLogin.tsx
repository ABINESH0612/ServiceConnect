...
const EXPECTED_ROLE: Role = 'CUSTOMER'
...
export default function CustomerLogin() {
  ...
  const onSubmit = async (values: LoginFormValues) => {
    ...
    try {
      ...
      // §14 — Role gate: reject if server role !== expected portal role
  ...
  return (
    <div className="sc-card p-8">
      ...
      {roleMismatch && (
        ...
        >
          This account is not registered as a customer. Please use the correct
          portal.
        </div>
      )}
