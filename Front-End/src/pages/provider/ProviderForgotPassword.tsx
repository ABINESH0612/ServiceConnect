      ...
      {submitted ? (
        <div className="text-center">
          ...
          <p className="text-sm text-[#64748B] mb-6">
            Check your email for reset instructions. If you have an account with
            us, you&apos;ll receive a password reset link shortly.
          </p>
          <Link to="/provider/login" className="sc-btn-outline inline-flex">
